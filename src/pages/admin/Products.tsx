...
import { Plus, Edit, Search, X, Image as ImageIcon, Upload, ArrowLeft } from 'lucide-react';
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button 
                        ...
                        className="p-2 text-neutral-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all text-xs font-bold"
                      >
                        <span>Hapus</span>
                      </button>
                    </div>
